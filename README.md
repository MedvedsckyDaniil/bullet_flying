...
| `def dd(i, argX, argY)`                                             | `i` – , <br/>`argX` – , <br/>`argY` – .                                                                                                                                                                                                                                                                                                                                     | Вспомогательная функция для рисоврения графиков. Она необходима чтобы указать на графике максимум. Она принимает номер иттерации, значение по оси х(там где будет указан пик) и значение по оси y чтобы его вернуть. В случае если был номер иттерации не совпадает с переданным значением x возвращается 0                                                                                                                                                                       |
