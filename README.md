...
| `def dd(i, argX, argY)`                                             | `i` – номер иттерации(текущий х при итеерации по нему), <br/>`argX` – значение по оси х(там где будет указан пик) , <br/>`argY` –  .                                                                                                                                                                                                                                                                                                                                     | Вспомогательная функция для рисоврения графиков. Она необходима чтобы указать на графике максимум. В случае если был номер иттерации не совпадает с переданным значением x возвращается 0                                                                                                                                                                       |
